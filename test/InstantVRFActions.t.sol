...
contract InstantVRFActionsTest is FullGameStack {
  ...
  function testCannotUseGreaterThanMaxActionAmountForASingleAction() public {
    ...
    instantVRFActions.doInstantVRFActions{value: cost}(
      playerId,
      _uint16s(input.actionId),
      _uints(MAX_INSTANT_VRF_ACTION_AMOUNT + 1)
    );
  ...
  function testCannotUseGreaterThanMaxActionAmountForCombinedActions() public {
    ...
    instantVRFActions.doInstantVRFActions{value: cost}(
      ...
      _uints(MAX_INSTANT_VRF_ACTION_AMOUNT - 2, 3)
    );
  ...
  function testCompletedInstantVRFActionsEventEmittedWithCorrectOutput() public {
    ...
    emit IInstantVRFActions.CompletedInstantVRFActions(
      ...
      playerId,
      1,
      _uints(RUNITE_ARROW, RUNITE_ARROW),
      _uints(2, 2),
      new uint256[](0)
    );
    _fulfill(1);
  ...
  function testAddStrategies() public {
    InstantVRFActionType[] memory actionTypes = _actionTypes(
      InstantVRFActionType.FORGING,
      InstantVRFActionType.GENERIC
    );
    address[] memory strategies = _addresses(
  ...
  function testAddingSameStrategyShouldRevert() public {
    instantVRFActions.addStrategies(
      _actionTypes(InstantVRFActionType.FORGING),
      _addresses(address(genericInstantVRFActionStrategy))
    );
  ...
  function testCheckRandomRewardsMany() public {
    ...
    uint256[] memory balances = itemNFT.balanceOfs(
      ALICE,
      _uint16s4(IRON_ARROW, MITHRIL_ARROW, ADAMANTINE_ARROW, RUNITE_ARROW)
    );
  ...
  function _withActionId(
    InstantVRFActionInput memory input,
    uint16 actionId
  ) private pure returns (InstantVRFActionInput memory x) {
  ...
  function _inputs(
    InstantVRFActionInput memory a,
    InstantVRFActionInput memory b
  ) private pure returns (InstantVRFActionInput[] memory v) {
  ...
  function _actionTypes(
    InstantVRFActionType a,
    InstantVRFActionType b
  ) private pure returns (InstantVRFActionType[] memory v) {
  ...
  function _uints6(
    ...
    uint256 e,
    uint256 f
  ) private pure returns (uint256[] memory v) {
    v = new uint256[](6);
    v[0] = a;
    v[1] = b;
    v[2] = c;
