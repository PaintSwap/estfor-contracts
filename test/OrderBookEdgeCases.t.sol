...
contract OrderBookEdgeCasesTest is EstforTest {
    ...
    function _cancels(IOrderBook.OrderSide side, uint256 price, uint256 length)
        private
        pure
        returns (IOrderBook.CancelOrder[] memory orders)
    {
    ...
    function testPartialConsumptionTracksOrdersOnBothSides() public {
        ...
        IOrderBook.Order[] memory remainingBid =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Buy, ORDERBOOK_TOKEN_ID, PRICE);
        ...
        IOrderBook.Order[] memory bids =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Buy, ORDERBOOK_TOKEN_ID, buyPrice);
        ...
        IOrderBook.Order[] memory remainingAsk =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Sell, ORDERBOOK_TOKEN_ID, buyPrice);
    ...
    function testPriceCapacityHandlesBoundsCompressionAndSpareSegments() public {
        ...
        vm.expectRevert(
            abi.encodeWithSignature(
                "SafeCastOverflowedUintDowncast(uint8,uint256)", uint8(72), uint256(type(uint72).max) + 1
            )
        );
        ...
        IOrderBook.Order[] memory compressedSpill =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Sell, tokenId, compressedPrice + tick);
    ...
    function testPriceCapacitySearchesTicksAndUsesAvailableLastSegment() public {
        ...
        IOrderBook.Order[] memory spilled =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Sell, ORDERBOOK_TOKEN_ID, PRICE + 2);
    ...
    function testStressCancellationAndMatchingAcrossFiveHundredOrders() public {
        ...
        IOrderBook.Order[] memory remainder =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Sell, ORDERBOOK_TOKEN_ID, PRICE);
    ...
    function testManyOrdersAcrossLevelsPreserveTreesAndReusedTombstones() public {
        ...
        IOrderBook.Order[] memory highBid =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Buy, ORDERBOOK_TOKEN_ID, PRICE + 3);
        ...
        orderBook.limitOrders(_order(IOrderBook.OrderSide.Buy, PRICE, QUANTITY));
        IOrderBook.Order[] memory reusedBid =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Buy, ORDERBOOK_TOKEN_ID, PRICE);
        assertEq(orderBook.getNode(IOrderBook.OrderSide.Buy, ORDERBOOK_TOKEN_ID, PRICE).tombstoneOffset, 1);
        ...
        IOrderBook.Order[] memory remainingHighAsks =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Sell, ORDERBOOK_TOKEN_ID, PRICE + 8);
        ...
        IOrderBook.Order[] memory reusedAsk =
            orderBook.allOrdersAtPrice(IOrderBook.OrderSide.Sell, ORDERBOOK_TOKEN_ID, PRICE + 4);
    ...
    function testERC1155CallbacksCannotReenterEveryTransferringEntryPoint() public {
        ...
        attackerBook.cancelAndMakeLimitOrders(
            _uints(2), _cancel(IOrderBook.OrderSide.Sell, PRICE + 1), _order(IOrderBook.OrderSide.Sell, PRICE + 2, 1)
        );
