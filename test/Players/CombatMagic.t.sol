...
import {ActionChoiceInput, AvatarInfo, EquipPosition, ItemInput, PendingQueuedActionState, Player} from "../../contracts/globals/players.sol";
...
contract CombatMagicTest is CombatTestBase {
  ...
  function _assertCombatXPAndDrops(
    QueuedActionInput memory action,
    uint256 startXP,
    uint256 rate,
    uint256 spawned
