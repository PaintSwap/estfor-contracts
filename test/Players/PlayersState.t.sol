...
import {Player, AvatarInfo, ItemInput, EquipPosition, PendingQueuedActionState, ActionChoiceInput, PackedXP} from "../../contracts/globals/players.sol";
import {Skill, CombatStyle, BoostType} from "../../contracts/globals/misc.sol";
import {ActionInput, ActionQueueStrategy, QueuedAction, QueuedActionInput, GUAR_MUL, RATE_MUL} from "../../contracts/globals/actions.sol";
...
import {NONE, BRONZE_AXE, XP_BOOST, COMBAT_BOOST, SKILL_BOOST, GATHERING_BOOST} from "../../contracts/globals/items.sol";
...
contract PlayersStateTest is FullGameStack {
  ...
  function _setupProcessingChoice(
    bool fullChoice,
    bool fullAction,
    uint256 rate
  ...
  ) private pure returns (QueuedActionInput[] memory x) {
