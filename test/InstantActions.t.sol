...
contract InstantActionsTest is FullGameStack {
  ...
  function testAnyInputsBurntGenericAndState() public {
    ...
    IInstantActions.InstantActionState memory state = instantActions.getInstantActionState(
      playerId,
      _uint16s(1),
      _uints(1),
      input.actionType
  ...
  function _input(
    IInstantActions.InstantActionType t
  ) private pure returns (IInstantActions.InstantActionInput memory x) {
    x.actionId = 1;
    x.actionType = t;
  ...
  function _inputs(
    IInstantActions.InstantActionInput memory a
  ) private pure returns (IInstantActions.InstantActionInput[] memory v) {
  ...
  function _inputs(
    IInstantActions.InstantActionInput memory a,
    IInstantActions.InstantActionInput memory b
  ) private pure returns (IInstantActions.InstantActionInput[] memory v) {
  ...
  function _types(
    IInstantActions.InstantActionType a
  ) private pure returns (IInstantActions.InstantActionType[] memory v) {
  ...
  function _uint16s8(
    ...
    uint16 g,
    uint16 h
  ) private pure returns (uint16[] memory v) {
    v = new uint16[](8);
    v[0] = a;
    v[1] = b;
    v[2] = c;
