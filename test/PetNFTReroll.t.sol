...
contract PetNFTRerollTest is EstforTest {
  event CompletePetReroll(
    ...
    uint256 indexed originalPetTokenId,
    uint256 indexed newPetTokenId,
    uint256 requestId
  );
  ...
  function setUp() public {
    mockVRF = new MockVRF();
    IPetNFTReroll implementation = IPetNFTReroll(_deployArtifact("contracts/PetNFTReroll.sol:PetNFTReroll"));
