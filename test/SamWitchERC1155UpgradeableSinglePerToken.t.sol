...
import {TestSamWitchERC1155UpgradeableSinglePerToken} from "../contracts/test/external/TestSamWitchERC1155UpgradeableSinglePerToken.sol";
...
contract SamWitchERC1155UpgradeableSinglePerTokenTest is EstforTest {
  ...
  function testSafeTransferFromRevertsWhenAmountExceedsBalance() public {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(IERC1155Errors.ERC1155InsufficientBalance.selector, address(this), 1, 2, FIRST_TOKEN_ID)
    );
  ...
  function testBurnBatchRevertsWhenTokenIsNotOwned() public {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(IERC1155Errors.ERC1155InsufficientBalance.selector, address(this), 0, 1, SECOND_TOKEN_ID)
    );
