...
interface PlayersImplQueueActions {
    function checkAddToQueue(
        address from_,
        uint256 playerId,
        QueuedActionInput calldata queuedActionInput,
        PendingQueuedActionProcessed calldata pendingQueuedActionProcessed,
        QuestState calldata pendingQuestState
    ) external view returns (bool setAttire);
    function clearEverything(address from_, uint256 playerId, bool processTheActions) external;
    ...
    function startActions(
        uint256 playerId,
        QueuedActionInput[] calldata queuedActionInputs,
    ...
    function validateActionsImpl(address owner, uint256 playerId, QueuedActionInput[] calldata queuedActionInputs)
        external
        view
