  ...
  ERC1155Holder
{
  ...
  function pendingPassiveActionState(
    uint256 playerId
  ) public view override returns (PendingPassiveActionState memory _pendingPassiveActionState) {
  ...
  function addPassiveActionBridge(uint256 playerId, uint256 actionId, uint256 startTime) external override onlyBridge {
