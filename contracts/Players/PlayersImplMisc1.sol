...
contract PlayersImplMisc1 is PlayersImplBase, PlayersBase, IPlayersMisc1DelegateView {
  ...
  function uri(
    ...
    uint256 overallLevel = PlayersLibrary.getLevel(PlayersLibrary.readXP(Skill.MELEE, packedXP)) +
      ...
      PlayersLibrary.getLevel(PlayersLibrary.readXP(Skill.FARMING, packedXP)) +
    ...
    string memory attributes = string(
      abi.encodePacked(
        ...
        ",",
        _getTraitNumberJSON("Farming level", PlayersLibrary.getLevel(PlayersLibrary.readXP(Skill.FARMING, packedXP))),
        ",",
