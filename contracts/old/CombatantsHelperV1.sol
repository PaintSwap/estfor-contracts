...
import {ICombatantsHelper} from "./dependencies/interfaces/ICombatantsHelper.sol";
...
contract CombatantsHelperV1 is UUPSUpgradeable, OwnableUpgradeable, ICombatantsHelper {
  ...
  function setPlayerLeftCombatantCooldownTimestampPenalty(uint24 cooldownTimestampPenalty) external onlyOwner {
  ...
  function applyPlayerCombatantCooldownPenalty(uint256 playerId) external onlyClans {
    PlayerInfo storage playerInfo = _playerInfos[playerId];
