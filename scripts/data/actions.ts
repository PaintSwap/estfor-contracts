...
export const allActions: ActionInput[] = [
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_BABY_DRAGON,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_FIRE_DEMON,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.BRIMSTONE, rate: 1 * 10}],
    randomRewards: [{itemTokenId: EstforConstants.NATURE_KEY, chance: 683, amount: 1}],
    combatStats: {
      melee: 30,
      magic: 50,
      ranged: 50,
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_LAVA_FIEND,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
    ...
    randomRewards: [
      ...
      {itemTokenId: EstforConstants.RING_5, chance: 1, amount: 1},
    ],
    combatStats: {
      melee: 40,
      magic: 40,
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_BABY_FROST_MAGE,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_ADULT_FROST_MAGE,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
    ...
    randomRewards: [
      ...
      {itemTokenId: EstforConstants.RING_4, chance: 1, amount: 1},
    ],
    combatStats: {
      melee: 40,
      magic: 80,
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_FROST_MAMMOTH_SHEEP,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
    ...
    guaranteedRewards: [],
    randomRewards: [
      {itemTokenId: EstforConstants.BONE_KEY, chance: 2185, amount: 1},
      {itemTokenId: EstforConstants.RING_3, chance: 1, amount: 1},
    ],
    combatStats: {
      melee: 120,
      magic: 40,
  ...
  {
    actionId: EstforConstants.ACTION_COMBAT_FROST_TITAN_GIANT,
    info: {
      skill: Skill.COMBAT,
      isAvailable: true,
      isDynamic: false,
    ...
    guaranteedRewards: [],
    randomRewards: [
      {itemTokenId: EstforConstants.DRAGON_KEY, chance: 4369, amount: 1},
      {itemTokenId: EstforConstants.BONE_KEY, chance: 1820, amount: 1},
      {itemTokenId: EstforConstants.RING_6, chance: 2, amount: 1},
    ],
    combatStats: {
      melee: 220,
      magic: 220,
