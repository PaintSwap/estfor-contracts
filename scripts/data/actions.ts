...
export const allActions: ActionInput[] = [
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_SKRIMP, rate: 100 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_ROJJA, rate: 80 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_GOLDFISH, rate: 75 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_MYSTY_BLUE, rate: 36 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_RAZORFISH, rate: 72 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_ROXA, rate: 60 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_STONECLAW, rate: 40 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_CRUSKAN, rate: 36 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_DOUBTFISH, rate: 25 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
  ...
  },
  {
    ...
    guaranteedRewards: [{itemTokenId: EstforConstants.RAW_ROSEFIN, rate: 24 * 10}],
    randomRewards: [],
    combatStats: {
      melee: 0,
      magic: 0,
