...
contract DeployGame is Script {
    ...
    function _deployGame1() private {
        ...
        worldActions =
            _uups("worldActions", "out/WorldActions.sol/WorldActions.json", "", _initializer("worldActions", _a0()));
        ...
        adminAccess =
            _uups("adminAccess", "out/AdminAccess.sol/AdminAccess.json", "", _initializer("adminAccess", _a(owner)));
        itemNFT = _uups(
            "itemNFT", "out/ItemNFT.sol/ItemNFT.json", "", _initializer("itemNFT", _a(royaltyReceiver, adminAccess))
        );
        ...
        orderBook =
            _uups("orderBook", "out/OrderBook.sol/OrderBook.json", "", _initializer("orderBook", _a(itemNFT, brush)));
        marketplace = _uups(
            "marketplace", "out/Marketplace.sol/Marketplace.json", "", _initializer("marketplace", _a(brush, owner))
        );
        playerNFT = _uups(
            "playerNFT",
    ...
    function _deployGame2() private {
        ...
        playersImplQueueActions = _linkedImplementation(
            "playersImplQueueActions", "out/PlayersImplQueueActions.sol/PlayersImplQueueActions.json"
        );
        playersImplProcessActions = _linkedImplementation(
            "playersImplProcessActions", "out/PlayersImplProcessActions.sol/PlayersImplProcessActions.json"
        );
        playersImplRewards =
            _linkedImplementation("playersImplRewards", "out/PlayersImplRewards.sol/PlayersImplRewards.json");
    ...
    function _deployGame3() private {
        ...
        territories = _uups(
            ...
            "",
            _initializer(
                "territories", _a(players, clans, brush, lockedBankVaults, itemNFT, vrf, adminAccess, activityPoints)
            )
        );
        ...
        bankRegistry =
            _uups("bankRegistry", "out/BankRegistry.sol/BankRegistry.json", "", _initializer("bankRegistry", _a0()));
        bankFactory = _uups(
            "bankFactory",
    ...
    function _wireGame() private {
        _call(
            bankRegistry,
            abi.encodeWithSignature(
                "setForceItemDepositors(address[],bool[])", _a(activityPoints, raids), _bools(true, true)
            )
        );
        ...
        _call(
            petNFT,
            abi.encodeWithSignature(
                "initializeAddresses(address,address,address)", instantVRFActions, players, territories
            )
        );
        _call(
            clans,
        ...
        _call(
            lockedBankVaults,
            abi.encodeWithSignature(
                "initializeAddresses(address,address,address)", territories, combatantsHelper, bankFactory
            )
        );
        ...
        _call(
            clans,
            abi.encodeWithSignature(
                "setXPModifiers(address[],bool)", _a(lockedBankVaults, territories, wishingWell), true
            )
        );
    }
    ...
    function _uups(string memory name, string memory artifact, bytes memory constructorArgs, bytes memory initializer)
        private
    ...
    function _linkedImplementation(string memory name, string memory artifact)
        private
    ...
    function _a(address a, address b, address c, address d, address e, address f)
        private
        pure
    ...
    function _a(address a, address b, address c, address d, address e, address f, address g)
        private
        pure
        returns (address[] memory values)
    {
    ...
    function _a(address a, address b, address c, address d, address e, address f, address g, address h)
        private
        pure
        returns (address[] memory values)
    {
    ...
    function _a(address a, address b, address c, address d, address e, address f, address g, address h, address i)
        private
        pure
        returns (address[] memory values)
    {
